...
public class WaveView extends View {
    ...
    public WaveView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            int wave_color = ta.getColor(R.styleable.WaveView_wave_color, Color.WHITE);
            int wave_alpha = ta.getInteger(R.styleable.WaveView_wave_alpha, 80);

            mAboveWavePaint.setColor(wave_color);
            mBelowWavePaint.setColor(wave_color);
            mBelowWavePaint.setAlpha(wave_alpha);
